...
public class MiniProgramBuyerController {
    ...
    @Operation(summary = "小程序二维码生成：不限制数量，但是限制长度，只能存放32为长度")
    ...
    @Operation(summary = "小程序二维码生成:只适用于少量场景，多数场景需要unlimited接口实现")
    ...
    @Operation(summary = "根据shortlink 获取页面参数")

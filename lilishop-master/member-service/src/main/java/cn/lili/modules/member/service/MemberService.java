...
//    Token autoRegister();
     ...
     * @param memberId    客户id
     * @param content     变动日志
     * @param pointSource 积分来源 {@link cn.lili.modules.member.entity.enums.PointSourceEnum}
     * @return 操作结果
     */
    Boolean updateMemberPoint(Long point, String type, String memberId, String content, String pointSource);

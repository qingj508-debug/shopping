...
public class CouponActivity extends BasePromotions {
    ...
    @Schema(description = "优惠券活动类型", allowableValues = "REGISTERED:新人赠券,INVITE_NEW：邀新赠券，AUTO_COUPON：自动赠券，SPECIFY：精确发券")
    ...
    @Schema(description = "活动范围", allowableValues = " DAY:每天, WEEK:每周, MONTH:每月")
    private String couponFrequencyEnum;

    @Schema(description = "活动范围详情,只有精准发券使用")

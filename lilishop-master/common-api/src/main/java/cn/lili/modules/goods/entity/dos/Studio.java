...
public class Studio extends BaseEntity {
    ...
    @Schema(description = "小程序直播码")
    private String qrCodeUrl;

    @Schema(description = "店铺ID")
    private String storeId;

    @Schema(description = "直播间商品数量")
    private Integer roomGoodsNum;

    @Schema(description = "直播间商品(最多展示两个商品：name/goodsImage)")
    private String roomGoodsList;

    @Schema(description = "推荐直播间")
    private boolean recommend;

    /**
     * @see StudioStatusEnum
     */
    @Schema(description = "直播间状态")

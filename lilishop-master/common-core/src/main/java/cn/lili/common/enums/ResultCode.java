...
public enum ResultCode {
    ...
    /**
     * 电子卡券（卡密商品）业务错误码，11030~11051。
     */
    CARD_KEY_SKU_NOT_FOUND(11030, "SKU不存在"),
    CARD_KEY_SKU_NOT_E_COUPON(11031, "仅电子卡券SKU可管理卡密"),
    CARD_KEY_STORE_ACCESS_DENIED(11032, "无权操作该店铺卡密"),
    CARD_KEY_DUPLICATE_CARD_NO(11033, "卡号已存在"),
    CARD_KEY_CARD_NO_REQUIRED(11034, "卡号不能为空"),
    CARD_KEY_CARD_SECRET_REQUIRED(11035, "卡密不能为空"),
    CARD_KEY_NOT_FOUND(11036, "卡密不存在"),
    CARD_KEY_CANNOT_VOID(11037, "仅未售卡密可作废"),
    CARD_KEY_IMPORT_LIMIT(11038, "单次导入不能超过10000行"),
    CARD_KEY_EXPORT_LIMIT(11039, "单次导出不能超过10000行"),
    CARD_KEY_E_COUPON_CART_FORBIDDEN(11040, "电子卡券请使用立即购买"),
    CARD_KEY_POOL_INSUFFICIENT(11041, "卡密库存不足"),
    CARD_KEY_MIXED_CHECKOUT(11042, "电子卡券请单独购买"),
    CARD_KEY_MULTI_E_COUPON_SKU(11043, "每次仅可购买一种电子卡券"),
    CARD_KEY_PROMOTION_FORBIDDEN(11044, "电子卡券不参与促销活动"),
    CARD_KEY_E_COUPON_NO_AFTER_SALE(11045, "电子卡券订单不支持售后"),
    CARD_KEY_ORDER_ACCESS_DENIED(11046, "无权查看该订单卡密"),
    CARD_KEY_GOODS_AUTH_REFUSE(11047, "商品审核未通过，无法管理卡密"),
    CARD_KEY_SKU_DELETED(11048, "商品或SKU已删除，无法管理卡密"),
    CARD_KEY_STORE_CLOSED(11049, "店铺已关闭，无法管理卡密"),
    CARD_KEY_STORE_SELL_FORBIDDEN(11050, "店铺已关闭，无法购买"),
    CARD_KEY_ZERO_PRICE(11051, "电子卡券订单金额异常"),
    CARD_KEY_STOCK_MANUAL_FORBIDDEN(11052, "电子卡券库存由卡池同步，不可手动调整"),
    ...
    USER_RECEIPT_REPEAT_ERROR(20013, "客户发票信息重复"),
    USER_RECEIPT_NOT_EXIST(20014, "客户发票信息不存在"),
    USER_EDIT_ERROR(20015, "用户修改失败"),
    USER_OLD_PASSWORD_ERROR(20016, "旧密码不正确"),
    USER_COLLECTION_EXIST(20017, "无法重复收藏"),
    USER_GRADE_IS_DEFAULT(20018, "客户等级为默认客户等级"),
    ...
    POINT_NOT_ENOUGH(31015, "当前客户积分不足购买当前积分商品！"),
    ...
    COUPON_CANCELLATION_SUCCESS(41002, "客户优惠券作废成功"),
    ...
    COUPON_MEMBER_NOT_EXIST(41015, "没有当前客户优惠券"),
    COUPON_MEMBER_STATUS_ERROR(41016, "当前客户优惠券已过期/作废无法变更状态！"),
     ...
     * 礼品卡（现金卡）
     */
    GIFT_CARD_CASH_CREATE_QUANTITY_ERROR(41142, "制卡数量须在1-10000之间"),
    GIFT_CARD_CASH_ACTIVITY_NOT_FOUND(41150, "礼品卡活动不存在"),
    GIFT_CARD_CASH_ACTIVITY_OVER_STOCK(41151, "超出活动库存，无法继续制卡"),
    GIFT_CARD_CASH_ACTIVITY_EDIT_FORBIDDEN(41152, "活动已产生制卡记录，不能修改面额与核心规则"),
    GIFT_CARD_CASH_ACTIVITY_DELETE_FORBIDDEN(41153, "活动下已有制卡或凭证数据，不能删除"),
    GIFT_CARD_CASH_ACTIVITY_STOCK_LT_PRODUCED(41154, "活动库存不能小于已占用张数（制卡+发卡）"),
    GIFT_CARD_CASH_CREATE_BATCH_NOT_FOUND(41144, "制卡批次不存在"),
    GIFT_CARD_CASH_MEMBER_NOT_FOUND(41145, "手机号未找到对应会员"),
    GIFT_CARD_CASH_ISSUE_IMPORT_ERROR(41146, "发卡导入文件解析失败"),
    GIFT_CARD_CASH_ISSUE_POOL_INSUFFICIENT(41147, "活动库存不足，请减少发卡数量或提高活动总库存"),
    GIFT_CARD_CASH_ISSUE_ROW_ERROR(41148, "发卡导入数据有误"),
    ...
    FULL_DISCOUNT_GIFT_E_COUPON_ERROR(43010, "电子卡券不可作为满额活动赠品"),
    FULL_RATE_NUM_ERROR(43010, "请填写打折数值"),

    /**
     * 营销促销扩展
     */
    FLASH_DISCOUNT_NOT_EXIST_ERROR(43101, "限时直降活动不存在"),
    NTH_ITEM_DISCOUNT_NOT_EXIST_ERROR(43104, "第N件优惠活动不存在"),
    PROMOTION_SKU_CONFLICT(43106, "商品已在重叠时间段参与其他互斥促销活动"),
    PROMOTION_PRICE_ERROR(43107, "活动价格不能大于商品原价"),
    ...
    COUPON_ACTIVITY_MEMBER_ERROR(46002, "指定精准发券则必须指定客户，客户不可以为空"),
    ...
    KANJIA_ACTIVITY_LOG_MEMBER_ERROR(48009, "当前客户已经帮砍"),
    KANJIA_ACTIVITY_MEMBER_ERROR(48010, "当前客户已经发起此砍价商品活动"),
     ...
     * 直播相关
     */
    LIVE_GOODS_NOT_EXIST(80500, "直播商品不存在！"),
    LIVE_ROOM_NOT_EXIST(80501, "直播不存在！"),
    LIVE_ROOM_NOT_LIVING(80502, "直播状态错误，不可开播！"),
    LIVE_ROOM_NOT_ENDED(80503, "直播状态错误，不可结束！"),
    LIVE_ROOM_CREATE_ERROR(80504, "直播创建失败！"),
    LIVE_ROOM_EDIT_ERROR(80505, "直播修改失败！"),
    LIVE_ROOM_DELETE_ERROR(80506, "直播删除失败！"),
    LIVE_USER_NOT_EXIST(80507, "直播用户不存在！"),
    LIVE_USER_MUTE_EXIST(80508, "直播用户已被禁言！"),
    LIVE_MESSAGE_REMOVE_EXIST(80509, "直播消息删除失败！"),
    LIVE_COUPON_NOT_EXIST(80510, "直播优惠券不存在！"),
    LIVE_COUPON_RECEIVE_ERROR(80511, "当前直播未开始或已结束，无法领取优惠券"),

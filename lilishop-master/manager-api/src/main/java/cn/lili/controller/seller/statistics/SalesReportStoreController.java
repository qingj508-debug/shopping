...
@Tag(name = "店铺端,销售报表")
@RestController
@RequestMapping("/store/statistics/report")
public class SalesReportStoreController {
    ...
    private void applyStoreScope(SalesReportQueryParam param) {

<template>
  <div class="wx-channel-refund">
    <el-form :model="searchForm" inline label-width="70px" class="search-form">
      <el-form-item label="退单编号" prop="channelRefundSn">
        <el-input v-model="searchForm.channelRefundSn" placeholder="视频号退单编号" clearable style="width: 220px" />
      </el-form-item>
      ...
      <el-form-item label="状态" prop="status">
        <el-input v-model="searchForm.status" placeholder="退单状态" clearable style="width: 140px" />
      </el-form-item>
    ...
    <el-table v-loading="loading" border :data="data" class="mt_10" style="width: 100%">
      <el-table-column prop="channelRefundSn" label="视频号退单编号" min-width="200" show-overflow-tooltip />
      ...
      <el-table-column label="退单状态" width="130">
